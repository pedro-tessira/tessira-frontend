  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Operational health indicators and engineering intelligence.
          </p>
        </div>
      ...
      <div className="rounded-lg border border-border/50 bg-card p-12 text-center">
        <Activity size={32} strokeWidth={1.5} className="mx-auto text-muted-foreground/40" />
        <h3 className="mt-4 text-sm font-semibold">Health Dashboard</h3>
        <p className="mt-1 text-xs text-muted-foreground max-w-sm mx-auto">
          Track team sentiment, delivery velocity, and operational signals to identify issues before they escalate.
        </p>
