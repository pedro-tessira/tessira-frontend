...
export default function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast({ title: "Account created", description: "Welcome to Tessira." });
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between bg-primary p-12 text-primary-foreground">
        ...
        <div className="space-y-6 max-w-md">
          ...
          <p className="text-sm leading-relaxed text-primary-foreground/70">
            Join teams using Tessira to gain visibility into capacity, skills, and
            delivery health across their entire engineering organization.
          </p>
        </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 bg-background">
        ...
        <div className="w-full max-w-sm space-y-8">
          <div className="space-y-2 text-center lg:text-left">
            ...
            <p className="text-sm text-muted-foreground">Get started with Tessira in seconds</p>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to={routePaths.auth.login} className="font-medium text-primary hover:underline">
              Sign in
            </Link>
          </p>
        </div>
